...
test_electric =Electric_car('Tesla','E5000', 2035)
test_electric.battery.describe_range()

test_electric.battery.upgrade_battery()
test_electric.battery.describe_battery()
test_electric.battery.describe_range()
